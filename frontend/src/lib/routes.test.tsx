...
describe('routes helpers for active issues workspace routing', () => {
  ...
  it('renders empty props when getIssue rejects in the legacy /issues/[id] route', async () => {
  ...
  it('renders empty props when getOrganizations rejects in the legacy /issues/[id] route', async () => {
