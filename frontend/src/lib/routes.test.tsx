...
describe('routes helpers for active issues workspace routing', () => {
  ...
  it('falls back to the shared empty props contract when the legacy /issues/[id] route workspace slug lookup misses', async () => {
  ...
  it('falls back to the shared empty props contract when getOrganizations rejects in the legacy /issues/[id] route', async () => {
