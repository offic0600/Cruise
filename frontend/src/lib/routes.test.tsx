...
describe('routes helpers for active issues workspace routing', () => {
  ...
  it('renders the empty props contract when getIssue rejects in the legacy /issues/[id] route', async () => {
  ...
  it('renders the shared empty props contract when getOrganizations rejects in the legacy /issues/[id] route', async () => {
