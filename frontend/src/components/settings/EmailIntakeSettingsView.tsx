...
export default function EmailIntakeSettingsView() {
  ...
  return (
    <div className="space-y-6">
      <section className="ds-surface-card space-y-3 rounded-3xl p-5">
        <div>
      ...
      <div className="space-y-3">
        {(configsQuery.data ?? []).map((config) => (
          <div key={config.id} className="ds-surface-card flex items-center justify-between rounded-3xl p-5">
            <div>
