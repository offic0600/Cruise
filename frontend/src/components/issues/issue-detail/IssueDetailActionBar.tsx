...
export function IssueDetailActionBar({
  ...
  return (
    <div className="flex justify-end">
      <div className="ds-elevated-toolbar inline-flex max-w-full items-center gap-1.5 rounded-full px-1.5 py-1">
        ...
        <DropdownMenu>
          <div className="inline-flex h-9 items-center overflow-hidden rounded-full border border-border-soft bg-[color:var(--interactive-default)]">
            <Tooltip content="Copy as prompt">
              <button
                type="button"
                aria-label="Copy as prompt"
                onClick={() => void onCopyPrompt()}
                className="inline-flex h-9 items-center justify-center px-3 text-ink-700 outline-none transition hover:bg-[color:var(--interactive-hover)] hover:text-ink-900 focus:outline-none focus-visible:outline-none focus-visible:ring-0"
              >
            ...
            <DropdownMenuTrigger asChild>
              <button
                ...
                className="inline-flex h-9 items-center justify-center rounded-r-full px-2.5 text-ink-700 outline-none transition hover:bg-[color:var(--interactive-hover)] hover:text-ink-900 focus:outline-none focus-visible:outline-none focus-visible:ring-0 data-[state=open]:bg-[color:var(--interactive-hover)]"
              >
...
function ActionIconButton({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        'h-9 w-9 rounded-full border border-border-soft bg-[color:var(--interactive-default)] text-ink-700 shadow-none transition hover:bg-[color:var(--interactive-hover)] hover:text-ink-900',
        'outline-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 data-[state=open]:bg-[color:var(--interactive-hover)]',
        className
      )}
      {...props}
    >
