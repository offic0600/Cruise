...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="app-shell">
      <aside className={`glass-sidebar fixed inset-y-0 left-0 z-30 transition-transform xl:translate-x-0 ${mobileNavOpen ? 'translate-x-0' : '-translate-x-full'} xl:block`} style={{ width: 'var(--layout-sidebar-width)' }}>
          ...
          <nav className="flex-1 space-y-6 px-4 py-5">
            ...
            <div className="space-y-2">
                <button
                  ...
                  className="flex w-full items-center gap-1 px-3 text-left text-[13px] font-medium uppercase tracking-[0.16em] text-ink-400 transition hover:text-ink-700"
              ...
              <div className={`space-y-1 ${workspaceSectionOpen ? 'block' : 'hidden'}`}>
                ...
                <div className="space-y-1">
                  ...
                  {workspaceMoreOpen ? (
                    <div className="ml-3 space-y-1 rounded-2xl border border-border-soft bg-surface-elevated p-2 shadow-card">
      ...
      <div className="xl:ml-[var(--layout-sidebar-width)]">
